...
// let at = ["339","366","399","658","636","258","268","669","668","266","369","398","256","296","259","368","638","396","238","356","659","639","666","359","336","299","338","696","269","358","656","698","699","298","236","239"]
...
function getPINs(observed) {
  ...
  for (let k = 0; k < observed.length; k++) {
    const poss = obj[observed[k]];
    const tempResult = [];
    for (let i = 0; i < poss.length; i++) {
      for (let j = 0; j < result.length; j++) {
        tempResult.push(result[j] + poss[i]);
...
// console.log(getPINs('1357').length);
